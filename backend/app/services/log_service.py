...
class LogService:
    ...
    async def get_logs(self, page: int = 1, limit: int = 20, log_type: Optional[str] = None) -> Dict[str, Any]:
        """Fetch paginated system logs supporting type filters."""
    ...
    async def create_log(self, action: str, message: str, level: str = "INFO") -> None:
